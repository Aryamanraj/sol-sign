...
program
  ...
  .action(async (options) => {
    try {
      console.log(chalk.blue('🔐 Sol-Sign - Solana Message Signer\n'));
...
program
  ...
  .action(async (options) => {
    try {
      console.log(chalk.blue('🔍 Sol-Sign - Signature Verification\n'));
...
program
  ...
  .action(async (options) => {
    try {
      console.log(chalk.blue('🔐 Sol-Sign - Keypair Generator\n'));
